...
public class autocomplete_stockcheck extends ArrayAdapter<Item> {
    Context context;
    int resource, textViewResourceId;
    ArrayList<Item> items, tempItems, suggestions;

    public autocomplete_stockcheck (Context context, int resource, int textViewResourceId,ArrayList<Item> items) {
